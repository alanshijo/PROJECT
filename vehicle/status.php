...
if(isset($_POST['update'])){
    ...
    $sql="INSERT INTO `tbl_status`(`ws_id`, `description`, `img`,`open`,`close`, `status`,`show_status`) VALUES ('$id','$desc ','$img_name','$appt1','$appt2','$status','$s')";
    move_uploaded_file($_FILES['image']['tmp_name'],$target_dir.$img_name);
    $user_reg_query = mysqli_query($conn,$sql);
                        ...
                        <div class="col-xl-12 col-lg-20">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="form-group">
                                    ...
                                    &nbsp; <input type="radio" name="status" value="1" required/>Availble &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <input type="radio" name="status" value="0" required/>Not Available
                                </div>

                                <div class="form-group">
                                <label for="file_img"><strong>image:</strong></label>&nbsp;&nbsp;
                                    <input type="file"  id="image" name="image" placeholder="image" required/>
                                        <!-- &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        
                                        <a href="blockmech.php?block='.$mech_name.'" type="button" class="btn btn-outline-primary">Available</a>
                                        &nbsp;&nbsp;&nbsp;
                                        <a href="blockmech.php?unblock='.$mech_name.'" type="button" class="btn btn-outline-danger">Not Available</a> -->
                                </div>
