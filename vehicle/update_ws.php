...
//echo $email; exit;
//echo $pass; exit;
$q7="select ws_name,place,address,phone from tbl_workshop where username='".$n."'";
...
if(isset($_POST['update']))
{
  ...
  $sql2="update `tbl_mechanic` set mech_name='$mech_name',place='$place',address='$address', phone='$phone' where username='".$n."'";
  $result3 = mysqli_query($conn,$sql2);
  if($result2)
  {
    $update=true;
    echo'<script> alert ("Account Updated");</script>';
    echo'<script>window.location.href="view_wss.php";</script>';
  }else{
    echo'<script> alert ("username  already exists!");</script>';
    echo'<script>window.location.href="update_ws.php";</script>'; 
}
                            ...
                            <form class="user" method="post" action="" onsubmit="return Val();">
                                <div class="form-group">
                                    <!-- <div class="col-sm-6 mb-3 mb-sm-0"> -->
                                        <input type="text" class="form-control form-control-user" id="name" name="ws_name" value="<?php echo "$ws_name"; ?>"
                                            placeholder="Workshop Name" onkeyup="return Validstr1()"/>
                                    </div>
                                ...
                                <button class="btn btn-primary btn-user btn-block" name="submit">Update</button>
                                <hr>
