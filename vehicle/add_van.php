...
if(isset($_POST['submit'])){
    ...
    if($rsltcheck == 0){
        ...
        if($reg_query){
             ...
             $van_reg = "INSERT INTO `tbl_van`(`users_id`, `v_name`,  `address`,`place`, `phone`, `email`, `status`) VALUES ('$users_id','$vname','$address','$place','$phone','$email','$status')";
            $user_reg_query = mysqli_query($conn,$van_reg);
        ...
        echo'<script>window.location.href="add_van.php";</script>'; 
    }
}
?>
                            ...
                            <form class="user" method="post" action="" onsubmit="return Val();">
                                <div class="form-group">
                                    <!-- <div class="col-sm-6 mb-3 mb-sm-0"> -->
                                        <input type="text" class="form-control form-control-user" id="name" name="v_name"
                                            placeholder="Van Name" required onkeyup="return Validstr1();"/>
                                    </div>
